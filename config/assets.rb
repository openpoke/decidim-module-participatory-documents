...
# Register an additional load path for Shakapack
...
# Decidim::Shakapacker.register_stylesheet_import("stylesheets/decidim/participatory_documents/participatory_documents_admin", group: :admin)
