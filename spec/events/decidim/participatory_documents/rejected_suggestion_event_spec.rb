...
describe Decidim::ParticipatoryDocuments::RejectedSuggestionEvent do
  ...
  describe "email_subject" do
    it "is generated correctly" do
      expect(subject.email_subject).to eq("A suggestion you're following has been rejected")
    end
  end
  ...
  describe "email_intro" do
    it "is generated correctly" do
      expect(subject.email_intro)
        .to eq("A suggestion for \"<a href=\"#{resource_path}\">#{resource_title}</a>\" document has been rejected. You can read the answer in this page:")
    end
  end
  ...
  describe "notification_title" do
    it "is generated correctly" do
      expect(subject.notification_title)
        .to include("A suggestion for \"<a href=\"#{resource_path}\">#{resource_title}</a>\" document has been rejected")
    end
  end
