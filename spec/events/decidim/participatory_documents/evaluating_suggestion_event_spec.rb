...
describe Decidim::ParticipatoryDocuments::EvaluatingSuggestionEvent do
  ...
  describe "email_subject" do
    it "is generated correctly" do
      expect(subject.email_subject).to eq("A suggestion you're following is being evaluated")
    end
  end
  ...
  describe "email_intro" do
    it "is generated correctly" do
      expect(subject.email_intro)
        .to eq("A suggestion for \"<a href=\"#{resource_path}\">#{resource_title}</a>\" document is currently being evaluated. You can check the answer in this page:")
    end
  end
  ...
  describe "notification_title" do
    it "is generated correctly" do
      expect(subject.notification_title)
        .to include("A suggestion for \"<a href=\"#{resource_path}\">#{resource_title}</a>\" document is currently being evaluated")
    end
  end
end
